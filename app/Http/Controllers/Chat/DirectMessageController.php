...
class DirectMessageController extends Controller
{
    ...
    public function show(TicketUser $contact)
    {
        ...
        $messages = DirectMessage::betweenTicketUsers($user->id, $contact->id)->orderBy('created_at')->get();
    ...
    public function showSupport()
    {
        ...
        $messages = DirectMessage::betweenAdminAndTicketUser($user->id)->orderBy('created_at')->get();
